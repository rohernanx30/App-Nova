...
import com.example.nova_app.databinding.ActivityDiezBinding

class diez : AppCompatActivity() {
    var mediaPlayer: MediaPlayer? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        var binding: ActivityDiezBinding= ActivityDiezBinding.inflate(layoutInflater)
    ...
    private fun next(){
        var intent = Intent(this,fin_numeros::class.java)
