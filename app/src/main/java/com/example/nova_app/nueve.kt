...
import com.example.nova_app.databinding.ActivityNueveBinding

class nueve : AppCompatActivity() {
    var mediaPlayer: MediaPlayer? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        var binding: ActivityNueveBinding = ActivityNueveBinding.inflate(layoutInflater)
    ...
    private fun next(){
        var intent = Intent(this,diez::class.java)
